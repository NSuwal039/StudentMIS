...
urlpatterns=[
    ...
    path('transfer_history/',TransferListView.as_view(), name='transfer_history'),
    path('items/',ItemsListView.as_view(), name='item_list'),
    path('assets_assignment/',assets_department_assignment,name='assets_department_assignment'),
    ...
    #Procurement
    path('create_procurement_request/',CreateProcurementRequest.as_view(),name='create_procurement_request'),
    path('procurement_requests/',ProcurementRequestListView.as_view(), name='procurement_list'),
    path('procurement_status/', change_status, name='change_status'),
    path('procurement_details/<str:pk>', procurement_details, name='procurement_details'),

    #Transaction
    path('add_transaction/',TransactionCreateView.as_view(),name='create_transaction'),
    ...
    path('ajax/get_item_details', get_items_details_ajax, name='get_items_details_ajax'),
    # path('ajax/get_dept_amount', get_dept_amount_ajax, name='get_dept_amount_ajax'),
    path('ajax/get_dept_assets', get_dept_assets_ajax, name='get_dept_assets_ajax'),
    path('ajax/get_branch_assets', get_branch_assets_ajax, name='get_branch_assets_ajax'),
