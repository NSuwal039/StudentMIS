...
class Enquiry(models.Model):
    ...
    discovery_method = models.CharField(verbose_name = "How did you discover MWU?",max_length = 250, blank=True)
    ...
    # entrance_result = models.CharField(max_length=10, choices=RESULT, default='NA')
    # entrance_result_sent = models.BooleanField(default=False)
    # interview_result = models.CharField(max_length=10, choices=RESULT, default='NA')    
...
class Application(models.Model):
    ...
    enquiry = models.OneToOneField(Enquiry, on_delete=models.CASCADE, null=True, blank=True)
    name = models.CharField(max_length = 100)
    photo = models.ImageField(upload_to='application/student', null=True, blank=True)
    ...
    discovery = models.TextField(verbose_name = "How did you discover MWU?",null=True, blank=True)
