...
def assignment_log(request):
    ...
    return render(request,'academic/loghistory/individuals/assignment.html',context)
...
def semester_log(request):
    ...
    return render(request,'academic/loghistory/individuals/semester.html',context)
...
def subject_log(request):
    ...
    return render(request,'academic/loghistory/individuals/subject.html',context)
...
def section_log(request):
    ...
    return render(request,'academic/loghistory/individuals/section.html',context)
...
def syllabus_log(request):
    ...
    return render(request,'academic/loghistory/individuals/syllabus.html',context)
...
def routine_log(request):
    ...
    return render(request,'academic/loghistory/individuals/routine.html',context)
