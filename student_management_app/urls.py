...
from school_apps.lms.views import advanced_search, get_book_category_csv, get_books_csv, get_book_issues_csv
...
urlpatterns = [
    ...
    #for admin
     ...
     #for book csv
      path('api/book-category-csv/', get_book_category_csv),
      path('api/books-csv/', get_books_csv), 
      path('api/book-issues-csv/', get_book_issues_csv),
      path('api/advanced-search/',advanced_search),
]